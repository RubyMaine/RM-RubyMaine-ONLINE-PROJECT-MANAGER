...
<div class="container-fluid">
    <form action="" id="report-form">
        ...
        <div class="form-group">
            <label for="work_type_id" class="control-label"> Тип работы </label>
        ...
        <div class="form-group">
            <label for="datetime" class="control-label"> Дата/Время От </label>
        ...
        <div class="form-group">
            <label for="datetime" class="control-label"> Дата/Время до </label>
