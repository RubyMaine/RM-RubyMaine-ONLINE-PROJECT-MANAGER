...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <dl>
                <dt class="text-muted"> Сотрудник: </dt>
    ...
    <div class="row">
        <div class="col-md-6">
            <dl>
                ...
                <dt class="text-muted"> Дата/Время От: </dt>
    ...
    <div class="row">
        <div class="col-md-12">
            <label for="" class="text-muted control-label"> Описание: </label>
            <div><?= html_entity_decode($description) ?></div>
        </div>
    </div>
    <div class="text-right">
        <?php if(isset($project_status) && $project_status != 2): ?>
        <button class="btn btn-primary btn-sm btn-flat" type="button" id="edit_report" style="border-radius: 4px;"><i class="fa fa-edit"></i> Редактировать </button>
        <button class="btn btn-danger btn-sm btn-flat" type="button" id="delete_report" style="border-radius: 4px;"><i class="fa fa-trash"></i> Удалить </button>
        <?php endif; ?>
