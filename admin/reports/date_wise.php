...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title"> Отчет о времени рендеринга на проект </h3>
					...
					<form action="" id="filter">
						<div class="row align-items-end">
							<div class="form-group col-md-3">
								<label for="" class="control-label"> Сотрудник: </label>
							...
							<div class="form-group col-md-4">
                                <button class="btn btn-primary btn-flat btn-sm"><i class="fa fa-filter"></i> Фильтровать </button>
			                    <button class="btn btn-sm btn-flat btn-success" type="button" id="print"><i class="fa fa-print"></i> Распечатать </button>
							</div>
						</div>
					</form>
			</fieldset>
        ...
        <div class="container-fluid">
			<div class="row">
				...
				<div class="col-8">
					...
					<h3 class="text-center"><b> Представленное время сотрудника для <?= $proj ?></b></h3>
					<h5 class="text-center"><b><?= $emp ?></b></h5>
					<h5 class="text-center"><b> по состоянию на </b></h5>
			...
			<table class="table table-bordered table-hover table-striped">
				...
				<tbody>
                    ...
                    <?php if($qry->num_rows <= 0): ?>
                        <tr>
                            <th colspan="5"><center> Нет данных </center></th>
                        </tr>
                    <?php endif; ?>
				</tbody>
				<tfoot>
					<tr class="bg-lightblue text-light bg-opacity-50">
						<th colspan="4" class="text-right"> Общее время визуализации: </th>
...
<script>
	$(document).ready(function(){
       ...
       $('#print').click(function(){
		   ...
		   var _h = $('head').clone()
		   var _el = $('<div>')
		   _h.find("title").text("Отчет о времени рендеринга на проект по сотруднику — просмотр для печати")
