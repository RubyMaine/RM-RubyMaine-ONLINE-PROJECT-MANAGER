...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		...
		<div class="card-tools">
			<button class="btn btn-sm btn-flat btn-success" id="print"><i class="fa fa-print"></i> Распечатать </button>
		</div>
	</div>
	<div class="card-body">
		<div id="outprint">
...
<script>
	$(document).ready(function(){
       $('#print').click(function(){
		   ...
		   var _h = $('head').clone()
		   var _el = $('<div>')
		   _h.find("title").text("Отчет о времени рендеринга на проект — просмотр для печати")
