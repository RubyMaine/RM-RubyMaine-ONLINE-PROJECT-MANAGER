...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title"> Список пользователей системы </h3>
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn btn-flat btn-primary" style="border-radius: 4px;"><span class="fas fa-plus"></span>  Создавать новое пользователь </a>
		</div>
	</div>
	<div class="card-body">
