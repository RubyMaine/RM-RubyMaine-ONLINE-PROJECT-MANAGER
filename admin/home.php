<h1><?php echo $_settings->info('name') ?> - "Панель управления администратора" </h1>
...
<div class="row">
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <span class="info-box-text"> Новые проекты </span>
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text"> Текущие проекты </span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text"> Закрытые проекты </span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text"> Всего сотрудников </span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text"> Всего отчетов </span>
            <span class="info-box-number text-right">
                <?php 
