...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-primary" style="border-radius: 4px;"><span class="fas fa-plus"></span> Добавить нового сотрудника </a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal("Добавить нового сотрудника","employees/manage_employee.php",'mid-large')
		})
		$('.edit_data').click(function(){
			uni_modal("Обновить данные о сотруднике","employees/manage_employee.php?id="+$(this).attr('data-id'),'mid-large')
		})
		$('.delete_data').click(function(){
			_conf("Вы уверены, что хотите удалить этого сотрудника навсегда?","delete_employee",[$(this).attr('data-id')])
		})
		$('.view_data').click(function(){
			uni_modal("Информация о сотруднике","employees/view_employee.php?id="+$(this).attr('data-id'))
		})
