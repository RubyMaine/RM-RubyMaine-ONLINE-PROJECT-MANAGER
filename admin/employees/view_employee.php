...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <dl>
                ...
                <dt class="text-muted"> Сгенерированный пароль: </dt>
    ...
    <div class="text-right">
        <button class="btn btn-flat btn-dark btn-sm" type="button" data-dismiss="modal" style="border-radius: 4px;"><i class="fa fa-times"></i> Закрить </button>
    </div>
</div>
